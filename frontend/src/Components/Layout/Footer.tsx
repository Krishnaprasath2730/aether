...
const Footer: React.FC = () => {
  return (
    <Box component="footer" sx={{ bgcolor: 'white', color: 'black', pt: 8, pb: 4, borderTop: '1px solid #eee', position: 'relative', overflow: 'hidden' }}>
      <Container maxWidth="xl">
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 4 }}>
          {/* Newsletter (Left/Top) */}
          <Box sx={{ flex: { xs: '1 1 100%', md: '0 0 35%' }, mb: { xs: 4, md: 0 } }}>
            <Box component="img" src={logo} alt="Aether" sx={{ height: 40, mb: 2 }} />
          ...
          {/* Links Columns */}
          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 6, flex: { xs: '1 1 100%', md: '0 0 auto' } }}>
            <Box sx={{ minWidth: 120 }}>
